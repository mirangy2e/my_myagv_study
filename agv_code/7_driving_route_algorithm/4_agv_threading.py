...
def process_frame(frame):
    ...
    # 노란색과 빨간색을 합친 마스크
    combined_mask = cv2.bitwise_or(yellow_mask, red_mask1 | red_mask2)
    
    # 노란색과 빨간색을 합친 영상
    result_image = cv2.bitwise_and(roi, roi, mask=combined_mask)
